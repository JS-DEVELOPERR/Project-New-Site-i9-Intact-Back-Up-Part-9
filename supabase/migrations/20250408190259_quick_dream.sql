/*
  # Fix Timezone Issues for Form Submissions

  1. Changes
    - Set timezone to America/Sao_Paulo for the database
    - Update formulario_contato table to handle submission_time in local timezone
    - Update agendamento_consultoria table to handle created_at in local timezone
    - Add timezone handling for all timestamp columns
...
-- Create agendamento_consultoria table with proper timezone handling
...
-- Create formulario_contato table with proper timezone handling
