/*
  # Fix Timezone Issues and Form Submissions

  1. Changes
    - Remove timezone conversion in created_at fields
    - Add timezone handling for submission dates
    - Update table constraints and defaults
